...
using Net6CoreApiBoilerplate.Api.Models;
using Net6CoreApiBoilerplate.Api.Utility.Extensions;
using Net6CoreApiBoilerplate.Services.Post;
using Net6CoreApiBoilerplate.Services.Post.Dto;

namespace Net6CoreApiBoilerplate.Api.Controllers
{
    [Authorize]
